...
```
x-anthropic-billing-header: cc_version=2.1.200.{suffix}; cc_entrypoint=cli; cch=00000;
```
...
- **VERSION**: Current Claude Code version (e.g., `2.1.200`)
- **ENTRYPOINT**: Normal Claude Code CLI sessions use `cli`

Claude Code 2.1.200 also supports optional billing-header fields that this extension does not currently emit for the normal main CLI path:
